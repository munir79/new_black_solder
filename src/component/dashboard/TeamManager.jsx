...
const TeamManager = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append('personName', formData.personName);
    ...
    try {
      if (editingId) {
        await updateTeamMember({ id: editingId, data: form }).unwrap();
      ...
      console.error(err);
      toast.error(`Failed to ${editingId ? 'update' : 'create'} team member. Please try again.`);
    } finally {
  ...
  const handleEdit = (member) => {
    setFormData({
      ...
      quote: member.quote || '',
      file: null,
      imagePreview: member.image.startsWith('http')
        ? member.image
        : `${baseUriBackend}${member.image}`,
    });
  ...
  const uniqueDesignations = [...new Set(data?.data?.map((member) => member.designation) || [])];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
            <div>
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-800 mb-2">Team Manager</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
              ...
              <select
                ...
                className="px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-transparent bg-white"
              >
              ...
              <button
                ...
                className="bg-gradient-to-r from-blue-600 to-blue-600 hover:from-blue-700 hover:to-blue-700 text-white px-6 py-3 rounded-xl font-semibold flex items-center gap-2 transition-all duration-200 shadow-lg hover:shadow-xl"
              >
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 mb-8 border border-gray-200 transform transition-all duration-300">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-800">
                {editingId ? 'Update Team Member' : 'Add New Team Member'}
              </h2>
              <button
                onClick={resetForm}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      name="quote"
                      placeholder="Enter a favorite quote (optional)"
                ...
                <div className="lg:col-span-2">
                  ...
                  <textarea
                    name="description"
                    placeholder="Enter professional bio and description"
              ...
              <div className="flex gap-3 pt-4">
                <button
                  ...
                  className="bg-gradient-to-r from-blue-600 to-blue-600 hover:from-blue-700 hover:to-blue-700 disabled:from-gray-400 disabled:to-gray-500 text-white px-8 py-3 rounded-xl font-semibold flex items-center gap-2 transition-all duration-200 shadow-lg hover:shadow-xl disabled:shadow-none"
                >
                  {isSubmitting ? (
                    <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {data?.data?.map((member) => (
            ...
            >
              ...
              {/* Content */}
              <div className="p-5">
                <h3 className="text-xl font-bold text-gray-800 mb-2">{member.personName}</h3>
                ...
                <div className="flex justify-between items-center text-xs text-gray-400 border-t border-gray-100 pt-3">
                  ...
                  <span>ID: {member._id.slice(-6)}</span>
                </div>
              </div>
            </div>
          ))}
          ...
          <div className="text-center py-12">
            <div className="bg-white rounded-2xl p-8 max-w-md mx-auto shadow-sm border border-gray-100">
              ...
              <button
                ...
                className="bg-gradient-to-r from-blue-600 to-blue-600 hover:from-blue-700 hover:to-blue-700 text-white px-6 py-3 rounded-xl font-semibold flex items-center gap-2 transition-all duration-200 shadow-lg hover:shadow-xl mx-auto"
              >
                <FiPlus size={18} />
        ...
        {data?.pagination?.totalPages > 1 && (
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 py-6 border-t border-gray-200">
            <p className="text-gray-600 text-sm">
              ...
              {data.pagination.totalPages * limit} members
            </p>
