...
// import { baseUriBackend } from '@/url/commonUrl';
...
import { useCreateServiceMutation, useDeleteServiceMutation, useGetServiceQuery, useUpdateServiceMutation } from '@/redux/feature/serviceApi';
...
const ServiceManager = () => {
  ...
  // RTK Query hooks
  const { data, isLoading, refetch } = useGetServiceQuery({ page, limit, search });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        await updateService({ id: editingId, data: form }).unwrap();
      ...
      console.error(err);
      toast.error(`Failed to ${editingId ? 'update' : 'create'} service. Please try again.`);
    } finally {
  ...
  const handleEdit = (service) => {
    setFormData({
      ...
      file: null,
      imagePreview: service.image.startsWith('http')
        ? service.image
        : `${baseUriBackend}${service.image}`,
      price: service.price,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
            <div>
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-800 mb-2">Service Manager</h1>
              <p className="text-gray-600">Manage your services and offerings in one place</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
              ...
              <button
                ...
                className="bg-gradient-to-r from-gray-600 to-gray-900 hover:from--700 hover:to-gray-700 text-white px-6 py-3 rounded-xl font-semibold flex items-center gap-2 transition-all duration-200 shadow-lg hover:shadow-xl"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex gap-3 pt-4">
                <button
                  ...
                  className="bg-gradient-to-r from-gray-600 to-indigo-600 hover:from-gray-700 hover:to-indigo-700 disabled:from-gray-400 disabled:to-gray-500 text-white px-8 py-3 rounded-xl font-semibold flex items-center gap-2 transition-all duration-200 shadow-lg hover:shadow-xl disabled:shadow-none"
                >
                  {isSubmitting ? (
                    <>
          ...
          {data?.data?.map((service) => (
            ...
            >
              ...
              <div className="relative overflow-hidden">
                <img
                  src={`${baseUriBackend}${service.image}`}
                ...
                <div className="absolute top-3 right-3">
                  ...
                  <div className="relative">
                    <button
                      onClick={() => setMenuOpenId(menuOpenId === service._id ? null : service._id)}
          ...
          <div className="text-center py-12">
            <div className="bg-white rounded-2xl p-8 max-w-md mx-auto shadow-sm border border-gray-100">
              <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <FiType className="text-gray-400" size={24} />
              </div>
              ...
              <button
                ...
                className="bg-gradient-to-r from-gray-600 to-indigo-600 hover:from-gray-700 hover:to-indigo-700 text-white px-6 py-3 rounded-xl font-semibold flex items-center gap-2 transition-all duration-200 shadow-lg hover:shadow-xl mx-auto"
              >
                <FiPlus size={18} />
        ...
        {data?.pagination?.totalPages > 1 && (
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 py-6 border-t border-gray-200">
            <p className="text-gray-600 text-sm">
              ...
              {Math.min(data.pagination.page * limit, data.pagination.totalItems)} of{' '}
              {data.pagination.totalItems} services
            </p>
