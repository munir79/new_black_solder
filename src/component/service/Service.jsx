...
const productCategories = [
  {
    ...
    description:
      'Seamlessly visualize quality effectual capital without superior collaboration and idea such and asser sharing fiscally.',
        ...
        >
          ...
          <div className="text-center mb-12">
            ...
            <motion.h2 // <-- Animated Headline
              ...
              variants={textItemVariants}
            >
              AGzone Awesome & <span className={accentColor}>Fresh</span> Products
            </motion.h2>
          </div>
